...
BASE_URL = "https://www.thegrundy.org"
WHATSON_URL = "https://www.thegrundy.org/whats-on"
VENUE_NAME = "Grundy Art Gallery"
...
def scrape_grundy():
    ...
    try:
        ...
        raise RuntimeError("Failed to fetch Grundy: " + str(e)) from e

    soup = BeautifulSoup(r.text, "html.parser")
    for a in soup.find_all("a", href=True):
        href = (a.get("href") or "").strip()
        if "/whats-on/" not in href or href.rstrip("/") == "/whats-on":
            continue
