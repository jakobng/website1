...
BASE_URL = "https://www.cooper-gallery.com"
WHATSON_URL = "https://www.cooper-gallery.com/whats-on"
VENUE_NAME = "Cooper Gallery"
VENUE_CITY = "Barnsley"
HEADERS = {"User-Agent": "Mozilla/5.0 (compatible; NorthArtExhibitions/1.0)", "Accept-Language": "en-GB,en;q=0.9"}
TIMEOUT = 25


def scrape_cooper_gallery():
    out = []
    try:
        ...
        raise RuntimeError("Failed to fetch Cooper Gallery: " + str(e)) from e
    ...
    for a in soup.find_all("a", href=True):
        ...
        if not title or len(title) < 3:
            continue
        if title.lower() in ("what's on", "news", "visit"):
            continue
        date_text = ""
        parent = a.parent
        for _ in range(5):
